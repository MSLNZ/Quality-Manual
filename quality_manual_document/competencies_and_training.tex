...
\item The Quality Manager will verify the TCM change and set the status to ‘approved' in the TCM (a record of this is retained by the \deprecated{AODocs} versioning system)

\item A copy of the documents presented to the Quality Manager in support of the new competency will be saved in the relevant Competency Records folder in \deprecated{AODocs}.
\end{itemize}
...
\item \deprecated{another copy will be provided to the EDI site administrator, who will delete the TCM entry and set the status to `pending'} 

\item \deprecated{the Quality Manager will verify the change and set the TCM item status to ‘approved' (recorded by the AODocs version control system)}

\item a copy of the documents presented to the Quality Manager in support of the change will be filed for future reference in the relevant Technical Competencies folder within the MSL Quality Management System \deprecated{AODocs} library.
\end{itemize}
