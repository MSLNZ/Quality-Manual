...
A record of the review will be kept \deprecated{with other job records in the section file system}.
...
\deprecated{There is a streamlined process for registering and managing IANZ work, which available as an alternative to the usual job registration process. If this streamlined process is used, the record of review should be filed in the generic job for that section’s IANZ work.}