...
\item The client will be supplied with a copy of the report and the MD5 checksum for the report file (see ``Checking the integrity of a report file'', in MSL Guidelines on reporting and publishing \cite{MSL_Reporting_Guidelines}).
...
The section ``Electronic reports'' of the MSL Guidelines on Reporting and Publishing contains information on how to produce a calibration report file with a suitable MSL report cover and how to insert electronic signature images in that file \cite{MSL_Reporting_Guidelines}.
