...
\item A copy of the data and documents used to create the report shall be retained in the section file system (~see~\S\ref{ss:section_file_systems}~). 
...
\item Any change of information in the report must be clearly identified and, where appropriate, the reason for the change should be included in the report \proposed{(some advice on formatting is given in \cite[\S\ref*{GRP-ss:reissued_reports}]{MSL_Reporting_Guidelines} ).}
...
\proposed{\paragraph{Electronic reports} no special procedure is required to replace an electronic report. Simply dispatch a copy of the report to the client.
