...
\proposed{\item Externally published material (e.g., papers in scientific journals) is always subject to the terms of an agreement between the publisher and the authors. A copy of this agreement must be stored with the other documents in the repository.} 
