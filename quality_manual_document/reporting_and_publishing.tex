...
\begin{itemize}
\item the filename format should instead have the reissue number appended.  For example, the first reissue of the report will take the format Pressure_155_1997_reissue_1.pdf, the second Pressure_155_1997_reissue_2.pdf and so on.
