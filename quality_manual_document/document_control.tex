...
\item The corresponding entry in the register will be updated (by the Section's usual Chief Metrologist delegate checker) and checked by the Quality Manager (who sets the ‘approve’ attribute of the item – this change is recorded by the AODocs versioning system).
\end{itemize} 
