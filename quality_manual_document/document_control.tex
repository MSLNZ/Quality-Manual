...
\textbf{Client Feedback} & A hierarchy of folders where MSL sections can optionally choose to store feedback received in a central location. \\
...
\textbf{Management Reviews} & A folder containing subfolders of documents relating to each annual management review of the MSL Quality Management System. \\

\textbf{MQC documents} & A folder of MSL Quality Council working documents. \\

\textbf{MQC Meeting Minutes} & A folder containing MQC meeting agendas and minutes. \\
...
\textbf{Report Cover Templates} & A folder containing subfolders of past and present report cover templates. \\
...
A 'MSL Training Record' file will be maintained for each Member of the section, including contracted personnel.  The file will record professional development activities and events, including relevant authorisations, educational and professional qualifications, training, skills and other experience.
...
Changes might need to be made to one part of a procedure that do not impact on the validity of other parts. In such cases, the unaffected parts may continue to be used without re-validation. Nevertheless, the claim that parts remain valid must be reviewed, and the reasons for accepting the claim noted on the authoritative version of the procedure.
...
\item The team will complete a Validation Cover Sheet (available in the Quality Manual folder in SharePoint) and submit this, and the procedure, to the Quality Manager. 
...
The Validated Procedure Register is a the spreadsheet 'Validated Procedure List.xlsx' stored in the Validated Procedure Folder of the SharePoint library ( see \S\ref{ss:central_file_system} ). 
