...
\end{itemize}
\item The report will be filed \deprecated{in the MSL Main AO Docs library.} Management shall ensure that actions are carried out within an appropriate and agreed time frame.
\end{itemize}
