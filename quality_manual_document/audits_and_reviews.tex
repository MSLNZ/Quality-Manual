...
\deprecatedbox{The audit team shall produce a report on the scope and findings of the audit and decided actions in response to the audit. Corrective actions, recommendations and suggestions shall be clearly listed in the audit report (e.g. C1, R1, S1 etc). An Internal Audit Check-list may be used to assist documentation of the audit process for technical sections (there is an audit form template available in the docset (bucket) of the Internal Audits library).}

\proposedbox{Within one week of the audit, the audit team shall produce a report on the scope, findings and decided actions in response to the audit. Corrective actions, recommendations and suggestions shall be clearly listed in the audit report (e.g. C1, R1, S1 etc). An Internal Audit Check-list may be used to assist documentation of the audit process for technical sections (there is an audit form template available in the docset (bucket) of the Internal Audits library).

The Team Manager and section members involved shall be provided with a copy of the report. The report must be signed by the Team Manager to indicate acceptance of the audit findings (if areas of disagreement cannot be resolved, they may be noted in the signed document. However, an IRF must be raised promptly for any corrective action requests). Corrective actions arising from the audit shall be raised immediately as improvement requests (IRFs) by the Team Manager. } 

\deprecatedbox{ Recommendations will be recorded in the Internal Audit Register (Excel spreadsheet in the MQC Documents Library) by the Quality Manager. These recommendations must be considered by the section, and a summary response entered in the register. Responses will be reviewed at the next internal audit.  Suggestions do not require any response from the auditee.
...
The report \deprecated{, together with any notes collected during the audit,} will be provided to the Quality Manager \proposed{no later than two weeks after the audit}. The Quality Manager will sign the report when satisfied (and after ensuring that any IRFs have been raised). 

A copy of the report will be filed \deprecated{, with any notes,} in the Internal Audits library of the central file system. The Internal Audit Register file in the MQC Documents library will be updated by the Quality Manager.
