...
An MSL Member who has been approved as a Key Technical Personnel (KTP) for particular items in the scope of accreditation is authorised to sign IANZ endorsed calibration reports for these items.
...
After consultation with the Director, the Quality Manager appoints, in writing, the members of the MSL Quality Council (MQC). Membership tends to be for a period of twelve months initially, so that representation can be shared across MSL over time.
