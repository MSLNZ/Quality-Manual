...
\end{center}
\caption{MSL Organisational Structure (October 14, 2024)}
\label{fig:org_msl}
\end{figure}
...
After consultation with the Director, the Quality Manager appoints, in writing, the members of the MSL Quality Council (MQC). Membership tends to be for a period of twelve months, so that representation can be shared across MSL over time.
