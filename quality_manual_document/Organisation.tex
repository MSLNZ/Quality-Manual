...
Inside the MSL group, the role of Team Leader is recognised as someone who reports to the MSL Director and supervises staff.
...
Work Area Managers report on Health and Safety issues to their respective Team Leaders.
...
Teams shall be responsible for identifying and documenting potential risks to impartiality. Team Leaders will take account of these records when assigning tasks to staff.

Potential risks to impartiality may be identified by the process described in the corporate document \proposed{``Conflict of Interest Policy.docx''}. Individuals' declarations will not be available to other staff, but Team Leaders will have access to this information and can manage the associated risks. The accreditation body will not be able to access this private information. 
...
A senior metrologist is usually appointed as Quality Manager. So, that person occupies a line management position under the MSL Director and Team Leaders. This should not present a problem provided that, on matters of quality, the Quality Manager has direct access to the highest level of management in the organisation at which policy and resourcing decisions are made affecting the 
laboratory.
...
The Quality Manager is distinct from the MSL Director and Team Leader roles. The responsibility is discharged through monitoring and advising not by managing technical activities directly.
...
MSL is organised into \proposed{three} technical teams, each comprised of sections aligned with different technical areas of the SI (~see figure~\ref{fig:org_msl}~).
...
\end{center}
\caption{MSL Organisational Structure (October 1, 2025)}
\label{fig:org_msl}
\end{figure}
...
\paragraph{Team Leader}
Technical activities are organised into three teams, each with a Team Leader who has overall responsibility for technical operations, including provision of the resources needed to ensure the required quality of laboratory operations. 
...
An MSL Member who has been approved as a Key Technical Personnel (KTP) for particular items in the scope of accreditation is authorised to sign IANZ endorsed \proposed{calibration reports} for these items.
...
After consultation with the Director, the Quality Manager appoints, in writing, the members of the MSL Quality Council (MQC). Membership tends to be for a period of twelve months \proposed{initially}, so that representation can be shared across MSL over time.

\paragraph{Leadership Team}
The MSL Leadership Team includes the Director, the Chief Metrologist, the Quality Manager, the 
Team Leaders and the Business Support Specialist. 
