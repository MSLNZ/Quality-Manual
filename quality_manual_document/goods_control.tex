...
A template Goods Control Form is provided in the \deprecated{Quality Manual folder within the MSL Quality Management System AODocs site}.
...
\paragraph{Goods Control Form}
Another alternative is to record details on a ``Goods Control Form'', which will be filed \deprecated{within job records in the section file system.} 
