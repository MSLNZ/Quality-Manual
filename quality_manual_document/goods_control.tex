...
A 'Goods Log Book' may be used to record the date of receipt, item, client name, recipient for each client item handled. Alternatively, this information may be recorded electronically as part of the section file system, or in JIRA if that is how sections have chosen to implement this.
...
A template Goods Control Form is provided in the Quality Manual folder within the MSL Quality Management System SharePoint site.
